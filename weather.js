...
var wednesday = [ 63, 44, 'Showers', SUNNY_RAIN[FLATLINE], 'Coronavirus'];
var thursday = [ 61, 40, 'Mostly Cloudy', CLOUDY_MOSTLY[FLATLINE], 'Showers'];
var friday = [ 67, 43, 'Partly Cloudy', CLOUDY_PARTLY[FLATLINE], 'Showers at night'];
